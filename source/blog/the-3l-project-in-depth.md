...
我们可以安全地做到这一点，因为语言运行时提供并推行**「头等环境」**。环境是一个对象，它<u>包含对系统中可用资源的引用</u>。
...
今天使用的操作系统的结构和接口大多是基于45年前的计算机科学状态，自那以后，人们做了更多的研究，极大地提高了我们当时的认知。
...
（另外，请参阅下面关于“不安全操作”的说民，以了解其他性能改进的可能性。）
